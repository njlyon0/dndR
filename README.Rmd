...
The goal of `dndR` is to provide a suite of Dungeons & Dragons (Fifth Edition a.k.a. "5e") related functions to help both players and Dungeon Masters (DMs). Below are short descriptions of the functions currently included in `dndR`. I am always willing to expand that list though so if you have a D&D-related task that could be cool as a function, please [post it as an Issue](https://github.com/njlyon0/dndR/issues) on this package's GitHub repository!
...
- **`monster_stats`** -- Return generic monster stat block of specified XP value or challenge rating (CR)
...
- **`encounter_creator`** -- Pick set of creature experience point (XP) values that constitute a balanced encounter of specified difficulty and given party composition information
