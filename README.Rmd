...
You can also check out the `pkgdown` style website for this package [here](https://njlyon0.github.io/dndR/) or a more--in my opinion--visually appealing vignette-style website I've created [here](https://njlyon0.github.io/dndR-website/). The latter website was created using [Quarto](https://quarto.org/).

## For Players and DMs

- **`roll`** -- Roll specified number of standard dice and sum their outcomes. "Standard" dice have the following number of sides: 100, 20, 12, 10, 8, 6, 4, 3, and 2
...
- **`pc_level_calc`** -- Identify the current level of a player character based on earned XP. Also returns the proficiency modifier to be used at that level
