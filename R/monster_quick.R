...
#'
#' @param xp (numeric) Experience Points of monster to quick build
#' @param cr (numeric) Challenge Rating of monster to quick build. Note that this is NOT necessary if XP is provided
#'
#' @importFrom magrittr %>%
#'
#' @export
monster_quick <- function(xp = NULL, cr = NULL){
